...
const Skeleton = () => {
	return (
		<div style={{width: '100%', height: '100vh'}}>
				<div style={{height: '10vh', width: '100%'}} className="skel-mask-navv skel-mask-all" />
				<div style={{height: '45vh', width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center'}} className="skel-mask skel-mask-all">
					<h2 className="d-none d-lg-block" style={{alignSelf: 'center', color: 'white', marginTop: '80px'}}>Bellefu - digital agro connect...</h2>
					<h3 className="d-block d-lg-none mt-3" style={{fontSize: '22px', alignSelf: 'center', color: 'white',}}>Bellefu - digital agro connect...</h3>

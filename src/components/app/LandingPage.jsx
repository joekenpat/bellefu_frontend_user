...
const Skeleton = () => {
	return (
		<div style={{width: '100%', height: '100vh'}}>
				...
				<div style={{height: '50vh', width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}} className="skel-mask skel-mask-all">
					...
					<div className="d-lg-block d-none" style={{alignSelf: 'center', width: '65%', height: '60px', borderRadius: '10px', marginTop: '5px', backgroundColor: 'white'}} />

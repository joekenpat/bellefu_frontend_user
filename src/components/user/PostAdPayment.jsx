...
export default function PostAdPayment(props) {
  ...
  const [reference, setReference] = useState(`bellefu-${makeid(11)}`);
  ...
  const componentProps = {
    ...
    amount:
      props.match.params.product_plan === "urgent"
        ? fee.urgent_upgrade_fee * 100
        : props.match.params.product_plan === "highlighted"
        ? fee.highlighted.upgrade_fee * 100
        : fee.featured_upgrade_fee * 100,
    name: `${profile.first_name} ${profile.last_name}`,
    phone: userData.phone,
    currency: "USD",
    reference,
        ...
        <Form onSubmit={onSubmitHandle}>
          <Card className="border-0">
            ...
            <Card.Body>
              ...
              paymentData.gateway_provider === "paystack" ? (
                <PaystackButton
                  style={{
                    marginTop: "30px",
